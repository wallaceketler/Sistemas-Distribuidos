 ...
 * @author wallace
 */
public class serverWeb extends UnicastRemoteObject implements fileManager, Runnable{

        
    public serverWeb() throws RemoteException{
    ...
    public void save(String msg) throws RemoteException {
        ...
        try{
            FileWriter gravador = new FileWriter("C:/Users/walla/Documents/arquivoWeb",true);
            gravador.write(msg);
            gravador.close();
        }catch(Exception e){
    ...
    public String retrieve() throws RemoteException {
        String retorno = "";
        try{
            FileReader leitor = new FileReader("C:/Users/walla/Documents/arquivoWeb");
    ...
    public void run() {
        ...
        try{
            ...
            reg.rebind("manager", new serverWeb());
